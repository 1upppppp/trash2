...
$gtypes =["[League of Legends]", "[Overwatch]", "[CS GO]", "[Hearthstone]", "[Dota 2]", "[Heroes Of The Storm]", "[Starcraft 2]", "[Call Of Duty]", "[Dota]", "[Rocket League]", "[Starcraft Broodwar]", "[World Of Tanks]", "[Starcraft]", "[World Of Warcraft]", "[WarCraft III]"];
